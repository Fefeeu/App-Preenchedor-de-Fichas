        ...
        <div className="s-currentstatus">
            <div className="c-1">
                ...
                <div className="movement">
                    <input type="number" {...register('deslocamento')}/><label>Desloc.</label>
                </div>
            </div>
            <div className="c-2">
                <div className="input-group-pv">
                    <label>PV Totais</label><input type="number" className="max-pv" {...register('pontosVidaBase')}/>
                </div>
                <input type="number" className="current-pv"/>
                <label>Pontos de vida atuais</label>
            </div>
            <div className="c-3">
                <input type="number" className="temp-pv" {...register('vidaTemporaria')}/>
            ...
            <div className="c-4">
                <div className="life-dice">
                    ...
                    <div className="input-type-dices">
                        ...
                        <select className="type-dice" {...register('dadoDeVida')}>
